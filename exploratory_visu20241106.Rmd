...
net_data <- net_data_load %>%
  select(site = Site, transect = Transect, final_ID = final_ID, plant_species=plant_species, field_ID=pollinator_field_ID, observed =observed, collected=collected, family=Family, genus= genus, species=final_species) #select columns of interest
...
#sort(levels(as.factor(net_data$family)))
```
