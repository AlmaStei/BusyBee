...
#remove floral simpson index (p= 0.319    for platform_simpson_mod1_beta_noRE)
...
# Compare the models with the performance package
platform_simpson_beta_comp1 <- compare_performance(platform_simpson_mod1_beta_noRE, platform_simpson_mod2_beta, platform_simpson_mod3_beta, platform_simpson_mod4_beta, platform_simpson_mod5_beta, metrics = c("AICc", "BIC", "R2", "ICC", "RMSE"))
# Print the comparison table
...
flower_cam_count_full <- envir_data %>%
  ...
  select(-c(Transect, minutes_since_9am, Floral_simpson_index, Pastinaca.sativa, Daucus.carota, top2_ratio)) %>%
