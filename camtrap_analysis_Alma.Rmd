...
Orinial Author:  Maximilian Sittinger (https://orcid.org/0000-0002-4096-8556)
Modifications Author: Alma Steireif

This R script does the following:
 - process and plot data from 3 Insect Detect camera traps, which were deployed above platforms in 9 different meadows in Sachsen-Anhalt, Germany from July to August 2024
...
```{r recording duration per session}
...
```{r time difference between tracked IDs}
...
# even if the number of months the camera traps were active differs
viridis_9 <- viridis_pal()(9) #numnber of sites
