...
brocken_dates <- brocken_dates %>% select(SITE, STATION, everything())
leipzig_dates <- leipzig_dates %>% select(SITE, STATION, everything())
magdeburg_dates <- magdeburg_dates %>% select(SITE, STATION, everything())
```  
