...
(stack_land <- envir_data_avg_long %>%
  ...
  scale_fill_manual(
    values = c("agri" = "#DABD61FF", "grass" = "#6D8325FF", "snh" = "#4B644BFF", "forest" = "#121510FF", "urban" = "#803342FF", "water" = "#A9CCE3"),
...
(pie_land <- envir_data_avg_long %>%
  ...
  theme(legend.position = "right") +
  scale_fill_manual(values = c("agri" = "#DABD61FF", "grass" = "#6D8325FF", "snh" = "#4B644BFF", "forest" = "#121510FF", "urban" = "#803342FF", "water" = "#A9CCE3")))
...
(avg2 <- avg1 %>%
  ...
  labs(title = "Average Flower Cover % per Site Type",
       x = "Site type",
...
plot_model(plantsimp_mod1_beta, 
           type = "est", 
           show.values = TRUE, 
           value.offset = 0.3,
           #sort.est = TRUE,
           axis.labels = c("Top 2 Flower Ratio",
                           ...
                           "Forest (1km Buffer)", 
                           "Young Restored Site")) +
    labs(title = "Flower survey: Floral Simpson Index", x = "Predictors",y = "Estimate") + 
...
ggplot(pred_plot_cover, aes(x = x_unscaled, y = predicted)) +
  ...
  labs(
    title = "Flower survey: Predicted Floral Simpson Index vs Flower Cover %",
    x = "Plot Cover",
...
plot_model(netting_mod4_NB, 
           ...
           axis.labels = c("Flower Cover % per Transect",
                           ...
                           "Top 2 Flower Ratio",
                           "Floral Simpson Index")) +
    labs(title = "Netting: Interaction counts", x = "Predictors",y = "Estimate") + 
    theme(axis.text.y = element_text(hjust = 0))  # 0 = left, 1 = right
...
plot(ggpredict(netting_mod4_NB, terms = "Site_type"))+
  labs(
    title = "Netting: Predicted Insect Counts vs Site Type",
    x = "Site Type",
...
ggplot(pred_wind, aes(x = x_unscaled, y = predicted)) +
  ...
  labs(
    title = "Netting: Predicted Interaction Counts vs Wind Velocity",
...
ggplot(pred_top2, aes(x = x_unscaled, y = predicted)) +
  ...
  labs(
    title = "Netting: Predicted Interaction Counts vs Ratio of Top 2 Flower Species",
...
ggplot(pred_floral, aes(x = x_unscaled, y = predicted)) +
  ...
  labs(
    title = "Netting: Predicted Interaction Counts vs Floral Simpson Index",
    x = "Floral Simpson Index",
    y = "Predicted Count of insects caught with netting"
  )
...
ggplot(pred_plot_cover, aes(x = x_unscaled, y = predicted)) +
  ...
  geom_ribbon(aes(ymin = conf.low, ymax = conf.high), 
              fill = alpha(predictor_colors[["Plot_Cover_T"]],0.5)) +
  labs(
    title = "Netting: Predicted Interaction Counts vs Floral Cover %",
...
plot_model(netting_rich_mod6_poiss, 
           type = "est", 
           show.values = TRUE, 
           value.offset = 0.3,
           #sort.est = TRUE,
           axis.labels = c("Days Since Start",
                           "Time of Day",
                           "Floral Simpson Index")) +
    labs(title = "Netting: Species Richness", x = "Predictors",y = "Estimate") + 
    theme(axis.text.y = element_text(hjust = 0))  # 0 = left, 1 = right
```
...
plot_model(netting_shannon_mod6_gauss, 
           ...
           axis.labels = c("Days Since Start",
                           "Wind Velocity",
                           "Time of Day")) +
    labs(title = "Netting: Shannon Index of Pollinator", x = "Predictors",y = "Estimate") + 
    theme(axis.text.y = element_text(hjust = 0))  # 0 = left, 1 = right
...
plot_model(netting_simpson_mod4_beta, 
           type = "est", 
           show.values = TRUE, 
           value.offset = 0.3,
           #sort.est = TRUE,
           axis.labels = c("Flower Cover % per Transect",
                            "Days Since Start",
                           "Young Restored Sites",
                           "Wind Velocity (km/h)",
                           "Time of day")) +
    labs(title = "Netting: Simpson Index of Pollinator", x = "Predictors",y = "Estimate") + 
    theme(axis.text.y = element_text(hjust = 0))  # 0 = left, 1 = right
...
ggplot(pred_days, aes(x = x_unscaled, y = predicted)) +
  ...
  geom_ribbon(aes(ymin = conf.low, ymax = conf.high), 
              fill = alpha(predictor_colors[["Days_since_start"]], 0.5)) +
  labs(
    title = "Netting: Predicted Pollinator Simpson Diversity vs Days Since Start",
    x = "Days Since Start",
...
ggplot(pred_minutes, aes(x = x_unscaled, y = predicted)) +
  ...
  geom_ribbon(aes(ymin = conf.low, ymax = conf.high), 
              fill = alpha(predictor_colors[["minutes_since_9am"]], 0.5)) +
  labs(
    title = "Netting: Predicted Pollinator Simpson Diversity vs Time of day",
    x = "Time of day",
    y = "Predicted Pollinator Simpson Diversity Index"
  ) 
```
...
plot_model(platform_count_mod4_nb, 
           type = "est", 
           show.values = TRUE, 
           value.offset = 0.3,
           #sort.est = TRUE,
...
plot_model(platform_shannon_mod6_gauss, 
           type = "est", 
           show.values = TRUE, 
           value.offset = 0.3,
           #sort.est = TRUE,
...
plot_model(flower_abundance_mod2_nb, 
           type = "est", 
           show.values = TRUE, 
           value.offset = 0.3,
           #sort.est = TRUE,
    ...
    labs(title = "Flower Camera: Abundance of Pollinators", x = "Predictors",y = "Estimate") + 
    theme(axis.text.y = element_text(hjust = 0))  # 0 = left, 1 = right
...
```{r flower_cam_count_reduced_mod1_nb, fig.width=6, fig.height=6}
...
```{r flower_cam_count_reduced_mod2_nb, fig.width=6, fig.height=6}
...
```{r flower_cam_count_reduced_mod3_nb, fig.width=6, fig.height=6}
...
```{r flower_cam_count_reduced_mod4_nb, fig.width=6, fig.height=6}
...
```{r flower_cam_count_reduced_mod5_nb, fig.width=6, fig.height=6}
...
```{r flower_cam_diversity_reduced_mod1_gauss, fig.width=6, fig.height=6}
# full model with insect SHANNON INDEX as response variable and environmental, weather and plant diversity variables as explanatory variables, and site as random effect
# linear model
...
```{r flower_cam_diversity_reduced_mod2_gauss, fig.width=6, fig.height=6}
...
```{r flower_cam_diversity_reduced_mod3_gauss, fig.width=6, fig.height=6}
...
```{r flower_cam_diversity_reduced_mod4_gauss, fig.width=6, fig.height=6}
...
```{r flower_cam_diversity_reduced_mod5_gauss, fig.width=6, fig.height=6}
...
```{r flower_cam_diversity_reduced_simpson_mod1_beta, fig.width=6, fig.height=6}
# full model with insect SIMPSON INDEX as response variable and environmental, weather and plant diversity variables as explanatory variables, and site as random effect
# beta regression model
flower_cam_diversity_simpson_mod1_beta <- glmmTMB(simpson_diversity 
                                         ~ average_flower_cover 
...
```{r flower_cam_diversity_reduced_simpson_mod2_beta, fig.width=6, fig.height=6}
...
```{r flower_cam_diversity_reduced_simpson_mod3_beta, fig.width=6, fig.height=6}
...
```{r flower_cam_diversity_reduced_simpson_mod4_beta, fig.width=6, fig.height=6}
...
## floral simpson index flower_cam_diversity_simpson_mod5_beta---------
# Get the original mean and SD of floral simpson index site  before scaling
floral_simpson_mean <- mean(planty$Floral_simpson_index_site, na.rm = TRUE)
floral_simpson_sd <- sd(planty$Floral_simpson_index_site, na.rm = TRUE)
# Get predictions on the scaled variable
pred_floral_simpson <- ggpredict(flower_cam_diversity_simpson_mod5_beta , terms = "Floral_simpson_index_site")
# Unscale the x-axis
pred_floral_simpson$x_unscaled <- (pred_floral_simpson$x * floral_simpson_sd) + floral_simpson_mean
# Plot
ggplot(pred_floral_simpson, aes(x = x_unscaled, y = predicted)) +
...
## average flower cover flower_cam_diversity_simpson_mod_beta---------
# Get the original mean and SD of average flower cover before scaling
avg_flower_cover_mean <- mean(planty$average_flower_cover, na.rm = TRUE)
avg_flower_cover_sd <- sd(planty$average_flower_cover, na.rm = TRUE)
# Get predictions on the scaled variable
...
#### FLower camera vs time second try

```{r}
  
flower_cam_since9am <- flower_camera_modelling %>%
  # count occurences of the same insect per minute 
  group_by(site, date , cam, flower_sp, Family, minutes_since_9am) %>%
  summarise(count = n(), .groups = 'drop')

#barplot of family caught over time
flower_cam_since9am %>%
  ggplot(aes(x = minutes_since_9am, y = count, fill = Family)) +
  geom_bar(stat = "identity") +
  facet_wrap(~site) +
  labs(title = "Flower camera: Insect Abundance by Family and Time since 9am",
       x = "Time since 9am (minutes)",
       y = "Insect Abundance") +
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))+
#no legend
  theme(legend.position = "none") 

# model with time since 9am as a predictor
flower_cam_since9am_mod1 <- lmer(count 
                                    ~ minutes_since_9am
                                    + (1 | site),
                                 data = flower_cam_since9am)
summary(flower_cam_since9am_mod1)
parameters(flower_cam_since9am_mod1)
#check the model
check_model(flower_cam_since9am_mod1, verbose = T)

#normality of minutes since 9am
summary(flower_cam_since9am$minutes_since_9am) # p-value = 0.0001, minutes since 9am is not normally distributed
datawizard::describe_distribution(flower_cam_since9am$minutes_since_9am)

#histogram og minutes since 9am¨
flower_cam_since9am %>%
  ggplot(aes(x = minutes_since_9am)) +
  geom_histogram(binwidth=1, fill = "lightblue", color = "black") +
  labs(title = "Histogram of Minutes since 9am",
       x = "Minutes since 9am",
       y = "Count")

#plot the predictions for the minutes since 9am
# Get predictions on the variable
pred_minutes_since_9am <- ggpredict(flower_cam_since9am_mod1 , terms = "minutes_since_9am")
# Unscale the x-axis
# Plot
ggplot(pred_minutes_since_9am, aes(x = x, y = predicted)) +
  #plot with predictor color
  geom_line(size = 1.2, color = predictor_colors[["minutes_since_9am"]]) +
  geom_ribbon(aes(ymin = conf.low, ymax = conf.high), 
              fill = alpha(predictor_colors[["minutes_since_9am"]], 0.5)) +
  labs(
    title = "Flower camera: Predicted Insect Abundance by Time since 9am",
    x = "Time since 9am (minutes)",
    y = "Predicted Insect Abundance"
  )
```
